...
namespace BBUnity.Actions
{
    ...
    public class MoveToGameObject : GOAction
    {
        ...
        [InParam("target")] [Help("Target game object towards this game object will be moved")]
        ...
        /// <remarks>
        ///     Verify the status of the task, if there is no objective fails, if it has traveled the road or is near the goal it
        ///     is completed
        ///     y, the task is running, if it is still moving to the target.
        /// </remarks>
        public override TaskStatus OnUpdate()
        {
            ...
            if (navAgent.destination != targetTransform.position)
                navAgent.SetDestination(targetTransform.position);
