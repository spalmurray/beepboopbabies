...
namespace BBUnity.Actions
{
    ...
    {
        /// <value>
        ///     Input game object Parameter that must have a BoxCollider or SphereColider, which will determine the area from
        ///     which the position is extracted.
        /// </value>
        [InParam("area")]
        [Help(
            "game object that must have a BoxCollider or SphereColider, which will determine the area from which the position is extracted")]
        ...
        /// <remarks>
        ///     Check if there is a NavMeshAgent to assign it one by default and assign it
        ///     to the NavMeshAgent the destination a random position calculated with <see cref="getRandomPosition()" />
        /// </remarks>
        public override void OnStart()
        {
            ...
            if (navAgent == null)
            {
                Debug.LogWarning(
                    "The " + gameObject.name +
                    " game object does not have a Nav Mesh Agent component to navigate. One with default values has been added",
                    gameObject);
        ...
        /// <remarks>
        ///     Check the status of the task, if it has traveled the road or is close to the goal it is completed
        ///     and otherwise it will remain in operation.
        /// </remarks>
        ...
        {
            var boxCollider = area != null ? area.GetComponent<BoxCollider>() : null;
            if (boxCollider != null)
            ...
            var sphereCollider = area != null ? area.GetComponent<SphereCollider>() : null;
