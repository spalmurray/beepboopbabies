...
namespace BBUnity.Actions
{
    ...
    public class SetVelocity : GOAction
    {
        ...
        [Help(
            "Game object where the velocity is set, if no assigned the velocity is set to the game object of this behavior")]
        public GameObject toSetVelocity;

        ///<value>Input Velocity Parameter.</value>
        [InParam("velocity")] [Help("Velocity")]
        public Vector3 velocity;

        /// <summary>Initialization Method of SetVelocity</summary>
        /// <remarks>
        ///     Check the GameObject which we apply the speed, look for the rigitbody component to add the speed
        ///     and if it does not exist, it adds a rigitbody by default.
        /// </remarks>
