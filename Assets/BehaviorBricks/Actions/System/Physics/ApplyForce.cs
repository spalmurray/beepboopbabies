...
namespace BBUnity.Actions
{
    ...
    public class ApplyForce : GOAction
    {
        ...
        [InParam("force")] [Help("Force to be applied")]
        public Vector3 force;

        ///<value>Input Game object where the force is applied Parameter.</value>
        [InParam("toApplyForce")]
        [Help(
            "Game object where the force is applied, if no assigned the force is applied to the game object of this behavior")]
        public GameObject toApplyForce;

        /// <summary>Initialization Method of ApplyForce.</summary>
        /// <remarks>
        ///     heckea the GameObject which we apply the force, look for the rigitbody component to add strength
        ///     and if it does not exist, it adds rigitbody by default.
        /// </remarks>
