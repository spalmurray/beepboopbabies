...
namespace BBUnity.Actions
{
    ...
    public class FromMouseToWorld : GOAction
    {
        ...
        /// <value>
        ///     Input LayerMask with layers Parameter that must be considered relevant to
        ///     calculate the game object and position under the mouse cursor.
        /// </value>
        [InParam("mask")]
        [Help(
            "LayerMask with layers that must be considered relevant to calculate the game object and position under the mouse cursor")]
        public LayerMask mask;

        ///<value>OutPut Game object under the mouse cursor Parameter.</value>
        [OutParam("selectedGameObject")] [Help("Game object under the mouse cursor")]
        public GameObject selectedGameObject;

        ///<value>OutPut Position under the mouse cursor Parameter.</value>
        [OutParam("selectedPosition")] [Help("Position under the mouse cursor")]
        ...
        /// <remarks>
        ///     Verify the status of the task, if there is no associated camera assigns the main camera, launches a raycast where
        ///     it is
        ///     pointing the mouse and if it finds an object it returns that object and Complete the task. Otherwise, the task
        ///     fails.
        /// </remarks>
