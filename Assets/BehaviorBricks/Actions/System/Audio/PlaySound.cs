...
namespace BBUnity.Actions
{
    ...
    public class PlaySound : GOAction
    {
        ...
        [InParam("clip")] [Help("The clip that must be played")]
        public AudioClip clip;

        private float elapsedTime;

        ///<value>Volume of the clip.</value>
        [InParam("volume")] [Help("Volume of the clip")]
        public float volume = 1f;

        ///<value>Wheter the action waits till the end of the clip to be completed.</value>
        [InParam("waitUntilFinish")] [Help("Wheter the action waits till the end of the clip to be completed")]
