...
namespace BBUnity.Actions
{
    ...
    public class AddComponent : GOAction
    {
        ...
        [InParam("game object")]
        [Help(
            "Game object to add the component, if no assigned the component is added to the game object of this behavior")]
        public GameObject targetGameobject;

        /// <summary>All Input Parameters of PlayAnimation action.</summary>
        /// <value>Type of the component that must be added.</value>
        [InParam("type")] [Help("Type of the component that must be added")]
        public string type;
