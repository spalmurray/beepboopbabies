...
namespace BBUnity.Actions
{
    ...
    public class Instantiate : GOAction
    {
        ...
        [OutParam("instantiated")] [Help("Returned game object")]
        public GameObject instantiated;

        ///<value>Input Object to be cloned Parameter.</value>
        [InParam("original")] [Help("Object to be cloned")]
        public GameObject original;

        ///<value>Input position for the clone Parameter.</value>
        [InParam("position")] [Help("position for the clone")]
        ...
        {
            original = Object.Instantiate(original, position, original.transform.rotation);
        }
