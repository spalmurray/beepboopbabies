...
namespace BBUnity.Actions
{
    ...
    public class LookAt : GOAction
    {
        ...
        [InParam("target")] [Help("Target game object")]
        ...
        /// <remarks>
        ///     In each Update Check the position of the target GameObject and rotate the vector where it points, the task fails
        ///     if you have no objective Gameobject associated with it.
        /// </remarks>
