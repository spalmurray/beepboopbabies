...
namespace BBUnity.Actions
{
    ...
    public class SendMessage : GOAction
    {
        ...
        [InParam("methodName")] [Help("Name of the method that must be called")]
        public string methodName;

        ///<value>Input Game object to send the message Parameter.</value>
        [InParam("game object")]
        [Help(
            "Game object to send the message, if no assigned the message will be sent to the game object of this behavior")]
