...
namespace BBUnity.Conditions
{
    ...
    public class IsTargetInSight : GOCondition
    {
        ...
        [InParam("target")] [Help("Target to check the angle")]
        public GameObject target;

        /// <summary>
        ///     Checks whether a target is in sight depending on a given angle, casting a raycast to the target and then compare
        ///     the angle of forward vector
