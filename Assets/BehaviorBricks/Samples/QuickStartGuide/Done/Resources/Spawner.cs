...
public class Spawner : MonoBehaviour
{
    ...
    /// <summary>
    ///     method that instantiates the gameobjet in a certain position and adds the BehaviorExcutor component to follow the
    ///     player
    /// </summary>
    private void Start()
    {
        var instance = Instantiate(prefab, position, Quaternion.identity);
        var behaviorExecutor = instance.GetComponent<BehaviorExecutor>();
