...
namespace BBSamples.PQSG // Programmers Quick Start Guide
{
	...
	///     It searches for the first light labeled with the 'MainLight' tag, and looks for its DayNightCycle script, returning
	///     the
    ...
    public class DoneIsNightCondition : ConditionBase
    {
        ...
        /// <summary>
        ///     Method invoked by the execution engine when the condition is used in a priority selector and its last value was
        ///     false.
        /// </summary>
        /// <returns>
        ...
        // again. We remove ourselves from the event, and notify the execution engine
        // that the new condition value is true (it is night again).
        public void OnSunset(object sender, EventArgs night)
        {
        ...
        /// <param name="e"></param>
        // Similar to OnSunset, but used when we are monitoring the sunrise.
        public void OnSunrise(object sender, EventArgs e)
        {
            light.OnChanged -= OnSunrise;
